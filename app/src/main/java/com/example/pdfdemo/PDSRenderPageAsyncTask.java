...
public class PDSRenderPageAsyncTask extends AsyncTask<Void, Void, Bitmap> {
    ...
    PDSRenderPageAsyncTask(Context context, PDFPage fASPage, SizeF sizeF, float f, boolean z, boolean z2, OnPostExecuteListener onPostExecuteListener) {
